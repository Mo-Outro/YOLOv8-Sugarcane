...
from ultralytics.nn.modules import (AIFI, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    ...
                                    C2f_ContextGuided, ContextGuidedBlock_Down, SPDConv, GSConv, VoVGSCSP, Conv_maxpool,
                                    ShuffleNetV2, LightConv)
...
from .modules.attention import (EMA, DAttention, SEAttention, CoordAtt, TripletAttention, SegNext_Attention)
from .modules.DySnakeConv import (DSConv, DySnakeConv, C2f_DySnakeConv, Bottleneck_DySnakeConv)
from .modules.aDown import ADown
from .modules.DualConv import C3_DualConv
from .modules.DySample import Dy_Sample
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 C3_ContextGuided, C2f_ContextGuided, SPDConv, SEAttention, EMA, GSConv, VoVGSCSP, DSConv, DySnakeConv,
                 C2f_DySnakeConv, Bottleneck_DySnakeConv, LightConv, ADown, C3_DualConv, C2f_Dual):
        ...
        elif m in (CoordAtt, MultiDilatelocalAttention, iRMB_EMA, SELayerV1, SELayerV2, EMA, DAttention,
                   TripletAttention, SegNext_Attention, Dy_Sample):
            c2 = ch[f]
            args = [c2, *args]
            ...
            args = [c1, c2, *args[1:]]
            if m in [BottleneckCSP, C3, C3TR, VoVGSCSP]:
                args.insert(2, n)  # number of repeats
                n = 1
